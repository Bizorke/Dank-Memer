...
module.exports = new GenericCommand(
  async () => ({
    ...
    description: 'Help fund Dank Memer to keep it alive and performing well, as well as earning some exclusive perks!\n\n[Patreon](https://www.patreon.com/dankmemerbot) - Monthly support\n\nIf you donate please remember to join [this server](https://discord.gg/ngy5hz9) and add Melmsie#0001 as a friend. Then send Melmsie a DM with your patreon name, and he will get you sorted out!',
